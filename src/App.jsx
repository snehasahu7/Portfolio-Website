...
function App(){
  ...
  return(
      ...
      <div className={lightmode? "bg-gradient-to-r  from-white to-sky-200 text:black" :"overflow-x-hidden text-neutral-300 antialiased selection:bg-cyan-300 selection:text-cyan-900" }>
